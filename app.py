...
DATA_URL = "https://raw.githubusercontent.com/jinwookyung-kurly-data/-/main/%EC%98%A4%EC%B6%9C%EC%9E%90%EB%8F%99%ED%99%94.csv"
...
# ==============================
with st.sidebar:
    st.header("🔎 자연어 날짜 선택""/n""(비어있을 땐 날짜 선택 사용 가능)")
